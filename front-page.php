...
get_header(); ?>
  ...
  <section id="intro">
    ...
    <div class="canvas-white text-red hidden-sm hidden-xs text-center">Learn more <i class="fa fa-chevron-down"></i></div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 txt-center">
            <i class="fa fa-hospital-o fa-7x"></i>
            <h2>Medicare</h2>
          </div><!-- .col-lg-4 -->
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 txt-center">
            <i class="fa fa-wheelchair fa-10x"></i>
          </div><!-- .col-lg-4 -->
